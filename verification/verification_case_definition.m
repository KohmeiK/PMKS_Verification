...
switch caseName
    ...
    case 'angled_slider_crank'
        config.sourceDirectory = fullfile(repoRoot, 'Mechanisms', 'Four_Bar_Slider', 'Angled_Slider_Crank');
        config.speedRpm = 10;
        config.inputSpeed = config.speedRpm * pi / 30;
        config.constraints = {
            'A', 'B';
    ...
    case 'offset_slider_crank'
        config.sourceDirectory = fullfile(repoRoot, 'Mechanisms', 'Four_Bar_Slider', 'Offset_Slider_Crank');
        config.speedRpm = 10;
        config.inputSpeed = config.speedRpm * pi / 30;
        config.constraints = {
            'A', 'B';
    ...
    case 'rocking_slider_crank'
        config.sourceDirectory = fullfile(repoRoot, 'Mechanisms', 'Four_Bar_Slider', 'Rocking_Slider_Crank');
        config.speedRpm = 10;
        config.inputSpeed = config.speedRpm * pi / 30;
        config.constraints = {
            'A', 'B';
