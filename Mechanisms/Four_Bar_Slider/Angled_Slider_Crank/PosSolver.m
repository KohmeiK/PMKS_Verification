...
% non-axis-aligned track. 30 degrees is deliberately moderate: the shared
% slope-intercept circle-line helper still uses tan(theta), which is unusable near
% a quarter turn, so a steep guide could not be cross-verified here until that
% helper is reformulated.
