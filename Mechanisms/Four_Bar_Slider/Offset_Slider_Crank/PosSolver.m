...
%
% Horizontal, like the original slider cases. What is new here is the *offset*:
% the guide runs 3 units above the crank pivot rather than through it. Every other
% slider case in v1 is in-line, which makes the two circle-line roots symmetric
% about the pivot; an offset breaks that symmetry, so the branch the solver keeps
% actually matters.
